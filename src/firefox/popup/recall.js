...
let recallBtn = document.querySelector('.recall')

/*  add event listeners to buttons */

// addBtn.addEventListener('click', addNote);
// clearBtn.addEventListener('click', clearAll);
recallBtn.addEventListener('click', getRelatedNotes);
...
//         return null
//     }
//     fetch('http://127.0.0.1:8000/recall/', {
//         method: 'POST',
//         headers: {
...
// document.activeElement.getElementsByTagName('p')[0].innerHTML;
